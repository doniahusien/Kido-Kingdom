...
export default function AdminProductsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = editProductId ? `https://backend-chi-sepia.vercel.app/api/products/${editProductId}` : 'https://backend-chi-sepia.vercel.app/api/products';
    ...
    if (res.ok) {
      if (editProductId) {
        setProducts(prev =>
          prev.map(p => (p.id === editProductId ? result.product : p))
        );
      } else {
